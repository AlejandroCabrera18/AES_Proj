...
// Shift rows 
void shift_rows(byte *byte_array, unsigned char * state) {
...
// Mix Columns 
// uses mul2 and mul3 look-up tables 
void mix_columns(byte *byte_array, unsigned char * state) {
	byte* state[16] = byte_array;
	byte temp[16];
	byte mul2[] =
	{
